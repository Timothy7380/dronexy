...
// Pilot Sign Up form (names / license number / phone / email / password), then Upload Documents
export default function SignUpPilotScreen({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.inner}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <TextField label="License Number" placeholder="000 000 0000 000" trailingIcon="checkmark-circle-outline" keyboardType="number-pad" />
          ...
          <PrimaryButton label="Continue" style={{ marginTop: 10 }} onPress={() => navigation.navigate('UploadDocuments')} />
